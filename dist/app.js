...
var CHI_RECOGNITION_THRESHOLD = exports.CHI_RECOGNITION_THRESHOLD = 0.015;
...
var FaceMess = function () {
  ...
  _createClass(FaceMess, [{
    ...
    value: function generateHistogramValue() {
      console.log(_Histogram2.default.compareHistogram(_Histogram2.default.uniformBinary(_ImageProcessor2.default.getImageData(this.capturedCanvas)), utils.TRAINED_DATA['cham11ng']));
  ...
  _createClass(WebCam, [{
    ...
    value: function start(canvas, capturedCanvas) {
      ...
      var draw = function draw(video) {
        ...
        _this.compareFeature(capturedCanvas);
    ...
    value: function compareFeature(canvas) {
      var observedHistogram = _Histogram2.default.uniformBinary(_ImageProcessor2.default.getImageData(canvas));
      for (var key in utils.TRAINED_DATA) {
        if (utils.TRAINED_DATA.hasOwnProperty(key) && _Histogram2.default.compareHistogram(observedHistogram, utils.TRAINED_DATA[key]) <= utils.CHI_RECOGNITION_THRESHOLD) {
          console.log(key);
          this.stop();
          break;
        }
